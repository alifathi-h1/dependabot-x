...
class DependabotX:
    ...
    def enable_alerts(self, repos):
        ...
        try:
            print("\n[**] Enabling Dependabot alerts for " +
                  str(repos.totalCount) + " repo/s: \n")
            for repo in repos:
                ...
                try:
                    ...
                    print("[--] There was an error when updating " +
                          repo_name + ": " + str(E))
                    pass
        except Exception as E:
            print(E)
...
banner = pyfiglet.figlet_format(
    "Dependabot - X T o o l", width=130,  justify='center')
...
parser = argparse.ArgumentParser(
    description='Dependabot-X is a tool written in Python3 that allows GitHub Organization/User to automate enabling Dependabot alerts feature for all repositories. \n\n')
parser.add_argument('-o', '--org', help='Key in your organization name')
parser.add_argument('-a', '--personal-account',
                    help='Enable it for Your personal account', default=False, action="store_true")
